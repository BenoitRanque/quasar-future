...
var QModalLayout = {
  ...
  render: function render (h, ctx) {
    ...
    if (slots.header || ("ios" !== 'ios' && slots.navigation)) {
      child.push(h('div', {
    ...
    if (slots.footer || ("ios" === 'ios' && slots.navigation)) {
      child.push(h('div', {
...
var QIcon = {
  ...
  render: function render (h, ctx) {
    ...
    var
      ...
      icon = prop.mat && "ios" === 'mat'
        ? prop.mat
        : (prop.ios && "ios" === 'ios' ? prop.ios : ctx.props.name);
